...
def generate_report():
    ...
    with open(report_path, 'w') as f:
        ...
        f.write(
            f"  - Circuit Depth: ~{angle_cfg['n_qubits'] + (angle_cfg['n_layers'] * (angle_cfg['n_qubits'] * 2 + angle_cfg['n_qubits']))}\n\n")
        ...
        f.write(
            f"  - Circuit Depth: ~{amp_cfg['n_qubits'] + (amp_cfg['n_layers'] * (amp_cfg['n_qubits'] * 2 + amp_cfg['n_qubits']))}\n\n")
        ...
        f.write(
            f"{'Training Time (seconds)':<30} {angle_res['training_time']:<20.2f} {amp_res['training_time']:<20.2f}\n")
